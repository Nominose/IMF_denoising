"""
train_2D_lowT.py — Ablation: cDDPM trained only at low noise levels (t < 500)

Purpose: Verify that training only at low noise (high SNR) fails at few-step
inference, since high-noise endpoint denoiser is never trained.
Expected: NFE=1 very poor (t=T never seen), no sweet spot at any NFE.
"""
import sys
...
# ========== Parameters ==========
trial_name = 'cddpm_lowT_unsupervised_gaussian_brainCT'
