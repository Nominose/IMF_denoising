...
class Trainer(object):
    ...
    def train(self, pre_trained_model='/host/d/projects/denoising/models/flow_matching_unsupervised_gaussian_mayo/models/model-190.pt', start_step=None, beta=0, lpips_weight=0, edge_weight=0):
